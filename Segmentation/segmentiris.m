...
%eyeimage=imread('F:\4.2\dip\lab\database\file1.jpg');
...
%figure,subplot(1,2,1);imshow(eyeimage);title('originalimage');
%figure,subplot(1,2,1);imshow(imagepupil);title('pupil');
%figure,subplot(1,2,1);imshow(imagewithnoise);title('image with noise');
